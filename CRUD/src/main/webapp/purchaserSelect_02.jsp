...
<head>
<meta charset="UTF-8">
<title>고객 명단 수정 및 삭제</title>
<script type="text/javascript">
	function checkMember() {
		const regExpUserid = /^[\w|\d]*$/
...
<body>
	...
	<form action="purchaserSelect_03.jsp" name="member" method="post">
		<table>
			<tr>
			...
			<tr>
				...
				<td><input type="text" name="name"
					value="<%=session.getAttribute("OLDNAME")%>"></td>
			</tr>
			<tr>
				<td style="text-align: right">전화번호 :</td>
				<td><input type="text" name="phone"
					value="<%=session.getAttribute("OLDPHONE")%>"></td>
			</tr>
			<tr>
				<td style="text-align: right">주소 :</td>
				<td><input type="text" name="address"
					value="<%=session.getAttribute("OLDADDRESS")%>"></td>
			</tr>
		</table>
